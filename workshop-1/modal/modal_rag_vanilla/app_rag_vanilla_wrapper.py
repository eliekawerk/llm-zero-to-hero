...
from app_rag_vanilla import app as blocks  # Import Gradio app (from app_frontend.py)
from app_rag_vanilla import DB_FILE  # Load up the name of our DB file
...
app = modal.App("pdf-query-app-vanilla", image=image)

# Define a cloud file system for our logs DB
db_storage = modal.Volume.from_name("pdf-query-vanilla-logs", create_if_missing=True)
